(self["webpackChunktauri_theia"] = self["webpackChunktauri_theia"] || []).push([["vendors-node_modules_theia_mini-browser_lib_browser_mini-browser-frontend-module_js"],{
...
var mini_browser_endpoint_1 = __webpack_require__(/*! ../../common/mini-browser-endpoint */ "./node_modules/@theia/mini-browser/lib/common/mini-browser-endpoint.js");
/**
 * Fetch values from the backend's environment and caches them locally.
 * Helps with deploying various mini-browser endpoints.
 */
var MiniBrowserEnvironment = /** @class */ (function () {
    function MiniBrowserEnvironment() {
    }
    MiniBrowserEnvironment.prototype.postConstruct = function () {
        var _this = this;
        this._hostPatternPromise = this.getHostPattern()
            .then(function (pattern) { return _this._hostPattern = pattern; });
    };
    Object.defineProperty(MiniBrowserEnvironment.prototype, "hostPatternPromise", {
        get: function () {
    ...
    Object.defineProperty(MiniBrowserEnvironment.prototype, "hostPattern", {
        get: function () {
    ...
    MiniBrowserEnvironment.prototype.onStart = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._hostPatternPromise];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     */
    MiniBrowserEnvironment.prototype.getEndpoint = function (uuid, hostname) {
     ...
     * Throws if `hostPatternPromise` is not yet resolved.
     */
    MiniBrowserEnvironment.prototype.getRandomEndpoint = function () {
        return this.getEndpoint(uuid_1.v4());
    };
    MiniBrowserEnvironment.prototype.getHostPattern = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, environment_1.environment.electron.is()
                        ...
                        : this.environment.getValue(mini_browser_endpoint_1.MiniBrowserEndpoint.HOST_PATTERN_ENV)
                            .then(function (envVar) { return (envVar === null || envVar === void 0 ? void 0 : envVar.value) || mini_browser_endpoint_1.MiniBrowserEndpoint.HOST_PATTERN_DEFAULT; })];
            });
        });
    };
    MiniBrowserEnvironment.prototype.getDefaultHostname = function () {
    ...
    ], MiniBrowserEnvironment.prototype, "postConstruct", null);
    MiniBrowserEnvironment = __decorate([
        inversify_1.injectable()
    ], MiniBrowserEnvironment);
    return MiniBrowserEnvironment;
}());
...
var mini_browser_environment_1 = __webpack_require__(/*! ./environment/mini-browser-environment */ "./node_modules/@theia/mini-browser/lib/browser/environment/mini-browser-environment.js");
/**
...
var location_mapper_service_1 = __webpack_require__(/*! ./location-mapper-service */ "./node_modules/@theia/mini-browser/lib/browser/location-mapper-service.js");
var mini_browser_frontend_security_warnings_1 = __webpack_require__(/*! ./mini-browser-frontend-security-warnings */ "./node_modules/@theia/mini-browser/lib/browser/mini-browser-frontend-security-warnings.js");
...
/***/ "./node_modules/@theia/mini-browser/lib/browser/mini-browser-frontend-security-warnings.js":
/*!*************************************************************************************************!*\
  !*** ./node_modules/@theia/mini-browser/lib/browser/mini-browser-frontend-security-warnings.js ***!
  \*************************************************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/* harmony import */ var _css_loader_index_js_index_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../css-loader/index.js!./index.css */ "./node_modules/css-loader/index.js!./node_modules/@theia/mini-browser/src/browser/style/index.css");
...
//# sourceMappingURL=vendors-node_modules_theia_mini-browser_lib_browser_mini-browser-frontend-module_js.bundle.js.map