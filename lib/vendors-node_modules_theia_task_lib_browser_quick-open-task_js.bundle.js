(self["webpackChunktauri_theia"] = self["webpackChunktauri_theia"] || []).push([["vendors-node_modules_theia_task_lib_browser_quick-open-task_js"],{
    ...
    TaskConfigurationManager.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.workspaceService.onWorkspaceLocationChanged(function () {
                    _this.updateModels();
                });
                return [2 /*return*/];
            });
...
var TaskConfigurations = /** @class */ (function () {
    ...
    TaskConfigurations.prototype.getCustomizationForTask = function (taskConfig) {
        ...
        var customizationByType = this.getTaskCustomizations(taskConfig.type, taskConfig._scope) || [];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!(change.type === 2 /* DELETED */)) return [3 /*break*/, 2];
    ...
    TaskConfigurations.prototype.openUserTasks = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.taskConfigurationManager.openConfiguration(common_1.TaskScope.Global)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.saveTask(scope, task)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
    ...
    TaskConfigurations.prototype.getTaskCustomizationTemplate = function (task) {
        ...
        var customization = { type: task.type };
...
var TaskResolverRegistry = /** @class */ (function () {
     ...
     * @returns a `Disposable` that can be invoked to unregister the given resolver
     */
    TaskResolverRegistry.prototype.registerTaskResolver = function (type, resolver) {
        var _this = this;
        ...
        return {
            dispose: function () { return _this.taskResolvers.delete(type); }
        };
    };
    /**
    ...
    TaskResolverRegistry.prototype.getResolver = function (type) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.getTaskResolver(type)];
            });
        });
    };
    /**
     ...
     * @returns a promise of the registered `TaskResolver` or `undefined` if no resolver is registered for the given type.
     */
    TaskResolverRegistry.prototype.getTaskResolver = function (type) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, this.taskResolvers.get(type)];
                }
            });
        });
    };
     ...
     * @returns a `Disposable` that can be invoked to unregister the given resolver
     */
    TaskResolverRegistry.prototype.registerExecutionResolver = function (type, resolver) {
        var _this = this;
        ...
        return {
            dispose: function () { return _this.executionResolvers.delete(type); }
        };
    };
    /**
     ...
     * @returns a promise of the registered `TaskResolver` or `undefined` if no resolver is registered for the given type.
     */
    TaskResolverRegistry.prototype.getExecutionResolver = function (executionType) {
...
var TaskDefinitionRegistry = /** @class */ (function () {
    ...
    TaskDefinitionRegistry.prototype.getDefinition = function (taskConfiguration) {
        var e_2, _a;
        var definitions = this.getDefinitions(taskConfiguration.type);
    ...
    TaskDefinitionRegistry.prototype.compareTasks = function (one, other) {
        ...
        if (def) {
            ...
            return def.properties.all.every(function (p) { return p === 'type' || one[p] === other[p]; })
...
//# sourceMappingURL=vendors-node_modules_theia_task_lib_browser_quick-open-task_js.bundle.js.map