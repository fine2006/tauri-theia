(self["webpackChunktauri_theia"] = self["webpackChunktauri_theia"] || []).push([["vendors-node_modules_theia_monaco_lib_browser_monaco-frontend-module_js"],{
...
var MonacoThemingService = /** @class */ (function () {
    ...
    MonacoThemingService.prototype.cleanEmpty = function (obj) {
        for (var key in obj) {
...
function fetchOnigasm() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    onigasmPath = __webpack_require__(/*! onigasm/lib/onigasm.wasm */ "./node_modules/onigasm/lib/onigasm.wasm");
    ...
    MonacoTextmateService.prototype.initialize = function () {
        ...
        this.preferences.onPreferenceChanged(function (e) {
            if (e.preferenceName === 'editor.maxTokenizationLineLength') {
                _this.tokenizerOption.lineLimit = e.newValue;
            }
        });
        this.updateTheme();
...
//# sourceMappingURL=vendors-node_modules_theia_monaco_lib_browser_monaco-frontend-module_js.bundle.js.map