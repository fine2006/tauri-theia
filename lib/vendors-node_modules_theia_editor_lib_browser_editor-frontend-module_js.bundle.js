(self["webpackChunktauri_theia"] = self["webpackChunktauri_theia"] || []).push([["vendors-node_modules_theia_editor_lib_browser_editor-frontend-module_js"],{
...
var EditorNavigationContribution = /** @class */ (function () {
    ...
    EditorNavigationContribution.prototype.init = function () {
        ...
        this.toDispose.pushAll([
            ...
            this.editorManager.onCreated(function (widget) {
                _this.locationStack.removeClosedEditor(widget.editor.uri);
                widget.disposed.connect(function () { return _this.locationStack.addClosedEditor({
        ...
        this.commandRegistry.registerHandler(editor_command_1.EditorCommands.REOPEN_CLOSED_EDITOR.id, {
            execute: function () { return _this.reopenLastClosedEditor(); }
        });
    };
    /**
     ...
     */
    EditorNavigationContribution.prototype.reopenLastClosedEditor = function () {
        return __awaiter(this, void 0, void 0, function () {
            var lastClosedEditor, widget, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        lastClosedEditor = this.locationStack.getLastClosedEditor();
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.editorManager.open(lastClosedEditor.uri)];
                    case 2:
                        widget = _b.sent();
    ...
    EditorNavigationContribution.prototype.restoreState = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.restoreNavigationLocations()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.restoreClosedEditors()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    EditorNavigationContribution.prototype.restoreNavigationLocations = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    EditorNavigationContribution.prototype.restoreClosedEditors = function () {
        return __awaiter(this, void 0, void 0, function () {
            var raw, i, editor;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.storageService.getData(EditorNavigationContribution_1.CLOSED_EDITORS_KEY)];
                    case 1:
                        raw = _a.sent();
                        if (raw && raw.closedEditors) {
                            for (i = 0; i < raw.closedEditors.length; i++) {
                                editor = navigation_location_1.RecentlyClosedEditor.fromObject(raw.closedEditors[i]);
                                if (editor) {
    ...
    EditorNavigationContribution.prototype.shouldStoreClosedEditors = function () {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.bindEditorPreferences = exports.createEditorPreferences = exports.EditorPreferences = exports.editorPreferenceSchema = exports.DEFAULT_WORD_SEPARATORS = exports.EDITOR_MODEL_DEFAULTS = exports.EDITOR_FONT_DEFAULTS = void 0;
...
var EditorWidget = /** @class */ (function (_super) {
    ...
    function EditorWidget(editor, selectionService) {
        ...
        _this.toDispose.push(_this.editor.onSelectionChanged(function () { return _this.setSelection(); }));
        _this.toDispose.push(_this.editor.onFocusChanged(function () { return _this.setSelection(); }));
    ...
    EditorWidget.prototype.setSelection = function () {
...
var vscode_languageserver_types_1 = __webpack_require__(/*! @theia/core/shared/vscode-languageserver-types */ "./node_modules/@theia/core/shared/vscode-languageserver-types.js");
...
var NavigationLocationService = /** @class */ (function () {
    ...
    Object.defineProperty(NavigationLocationService.prototype, "closedEditorsStack", {
        /**
     ...
     */
    NavigationLocationService.prototype.getLastClosedEditor = function () {
     ...
     */
    NavigationLocationService.prototype.addClosedEditor = function (editor) {
     ...
     */
    NavigationLocationService.prototype.removeClosedEditor = function (uri) {
        this.recentlyClosedEditors = this.recentlyClosedEditors.filter(function (e) { return !uri.isEqual(e.uri); });
    };
...
/* harmony import */ var _css_loader_index_js_index_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../css-loader/index.js!./index.css */ "./node_modules/css-loader/index.js!./node_modules/@theia/editor/src/browser/style/index.css");
...
//# sourceMappingURL=vendors-node_modules_theia_editor_lib_browser_editor-frontend-module_js.bundle.js.map